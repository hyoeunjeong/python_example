...
아래 문제를 통해 파이썬 리스트의 다양한 기능을 활용해봅시다. 
도서관 책 관리 시스템을 만드는 과정에서 리스트의 여러 메서드를 실습해볼 것입니다.
...
print("파이썬 기초 권수",books.count("파이썬 기초"))
books.append("웹 개발의 시작") ##목록 끝에 추가
books.insert(2,"데이터베이스 설계") ##(인덱스,값) 삽입 

new_books =["인공지능 개론", "클라우드 컴퓨팅"] 
books.extend(new_books) ##추가  
print("2단계",books)
...
books 리스트를 완전히 비우고 출력하세요.
 '''
top_books = books[:3]
reversed_selection = books[1:5][::-1]  ##인덱스 1, 2, 3, 4를 슬라이싱한 후 뒤집기
print("top 3 book:",top_books)
print("reversed",reversed_selection)
books.clear()  ##모든항목 삭제제
print(books)
